...
Such steps can be repeted to continue the selection of factors until the point where we are no longer satisfied on the comparison between the real max statistic and the empirical distribution of lucky factors. 
