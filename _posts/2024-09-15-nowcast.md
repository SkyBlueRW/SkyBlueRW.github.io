...
How can we adapt to such unprecedented shocks so that we can arrive at reasonable estimates during Covid while avoiding excessive post-crisis volatility? This is defenitely a helpful question to ask, and the New York's update on their nowcasting model offers an excellent opportunity to explore it.

The New York Fed introduced its first-generation nowcasting model back in April 2016, but the model was suspended in September 2021 due to "unprecedented fluctuations in many input series during the COVID-19 pandemic posed significant challenges to estimating the model". Two years later, in September 2023, the New York Fed released a more robust version designed to better handle data volatility. Let's take a closer look at what has changed.
