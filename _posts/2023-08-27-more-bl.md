...
All the techniques discussed above should provide a good point to start for our use of the Black-Litterman model in real world application. Wihout doubt, Black-Litterman is a powerful and intuitive tools. It enables us to start from the reference portfolio and deviate in case of strong enough evidence. It definitely deserve a bit more brainstorm on on this model, on the idea it is representing, on the theoretical ground why and on what scenario should it work.
