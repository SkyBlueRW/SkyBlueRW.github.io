...
At this point before we call an end on this blog. I feel it definitely deserve a bit more brainstorm on the idea of combining more information to refine forecast on expected return and BLack-Litterman's role in the effort from the initial places


#### "The more the better?" <a name="subparagraph3"></a>

Though there are tons and tons of factors impacting the effective return of various securities, there is not a unified model for forecast!

We do have all kinds of drivers on expected return.
