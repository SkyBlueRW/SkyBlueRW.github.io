...
To faciliate the estimation and reduce the model risk originated from the large number of parameters, a lot of techniques with further restriction upon the Gassuan assumption are usually applied in the application. Let's look into some of these techniques to put the Bayesian framwork to application.
...
For sure this is not the 'correct' answer, while it does pick some points of the full picture.  
