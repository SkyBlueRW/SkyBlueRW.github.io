...
The final results of all backtests are displayed in the chart of the very begining of the blog. I have also list the detailed performance in the table below here "MD @ x Risk" representing the MD portfolio given x volatility target. As imagined in the first place, MD provides a reasonable solution as strategic asset allocation. I would like to hilight the following two points specifically
