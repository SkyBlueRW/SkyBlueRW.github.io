...
Now things become much simpler. We turn our confidence on one investment view to a consistent portfolio. It's not that hard to infer the corresponding $$\omega$$ from it. Walters (2007) provides an analytical solution for the step.
