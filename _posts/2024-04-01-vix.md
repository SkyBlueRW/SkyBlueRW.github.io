...
$$
 ...
 Also demonstrated in the simulation of Figure 3a from DDKZ(1999), a portfolio with inifnite number of options with different strikes appropriately weighted retains invariant vega irrespective of the move of underlying asset price and passage of time hence replicate the variance swap. 
