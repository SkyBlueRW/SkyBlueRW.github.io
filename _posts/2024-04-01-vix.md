...
Unfortunately, the instantaneous variance ($$sigma^2(t,...$$) is unknown, we can not calculate $$K_{var}$$ directly with the formular. While a well designed portfolio of options will do us the favor for the estimation of $$K_{var}$$.
