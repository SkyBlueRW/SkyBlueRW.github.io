...
$$F = E^Q[e^{-rT}(V - K)]$$. the fair delivery price should be the expectation of future realized volatility under the risk neutral measure - the price of future volatility entitled by the market and a natural measure for future volatility !
