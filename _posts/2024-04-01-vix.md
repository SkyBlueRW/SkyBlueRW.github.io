...
Now we have a portfolio of tradable options with observed prices to replicate the hypothetic variance swap. The calculation summarize the information of the full distribution through its use of options with different strikes. What does it capture economically? 
...
This is aligned empirical research. Jiang & Tian (2005) found the SPX VIX as a good estimator on future realized volatility even controlled for other indicators such as historical realized volatility. In their regression of future realized volatility against both VIX and historical, the slope on VIX remains the one that is significant, in some degree demonstrating VIX as an improved estimator on future volatility.

What's even more interesting about VIX is that, it's usually larger than the future realized volatility of corresponding period, reflecting investors' attitude toward future risk. Carr & Wu (2008) used this difference to measure the variance risk premium and stated that "investors are willing to pay extra money to enter into variance because they dislike variance, not just because it is anti-correlated with stock prices, but on its own right. This lead to many considerating variance as an asset clas in and of itself".

There is no doubt that both the magnitude of volatility and market's attitude toward risk matters a lot to the performance of risky asset and further to portfolio management. For example, there is generally concurrent or event leading peak of VIX on SPX at large turmoil of US equity market. VIX is definitely worth having a look, either on itself or some further calibrated indicators such as its term structure or its difference with recent realized volatility. 
