...
There is the subtle feeling when reading into a 'small' yet delicate model like volatility index (VIX) at the era of roaring Generative AI models! Like many others, I got shocked by the knowledge, judgement and beyond that can be gained from Generative AI via matrix operations involving billions of parameters. While it does not reduce any bit of my admiration on a delicate structural model like VIX as well as the inspiration and think behind it. 
