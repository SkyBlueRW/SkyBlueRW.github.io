...
It's easier to verify that such a portfolio of options scaled by $$\dfrac{1}{K^2}$$ has a constant vega under the assumption of BSM (Black-Schole-Schole option pricing). While the calculation of VIX itself does not depend on BSM hence the model free estimation.
