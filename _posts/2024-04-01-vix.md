...
Unfortunately, the instantaneous variance ($$\sigma^2(t,...)$$) is unknown, we can not calculate $$K_{var}$$ directly with the formula. With the spirit of security relative pricing, it turns out that a well designed portfolio of options will do us the favor for the estimation of $$K_{var}$$.

Long in short (put more details about the process in the appendix). 
